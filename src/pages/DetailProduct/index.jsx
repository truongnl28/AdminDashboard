          ...
          <div className="detail-info">
            <div className="owner-info">
              ...
              <div className="">
                ...
                <input
                  type="text"
                  value={user?.giver?.phoneNumber ?? "N/A"}
                  readOnly
                />
              </div>
              <div className="">
              ...
              <div className="">
                ...
                <input
                  style={{
                    color: `${
                      user?.giver?.isDeleted === true ? "red" : "blue"
                    }`,
                  }}
                  type="text"
                  value={
                    user?.giver?.isDeleted === true ? "Not active" : "Active"
                  }
                  readOnly
                />
              </div>
            ...
            <div className="item-info">
              ...
              <div className="time">
                <div className="receiving-time">
                  <label htmlFor="">Thời gian đến nhận</label>
                  <input
                    type="text"
                    value={moment(user?.pickupTime).format("DD/MM/YYYY")}
                    readOnly
                  />
                </div>
                <div className="expiration-date">
                  ...
                  <input
                    type="text"
                    value={moment(user?.duration).format("DD/MM/YYYY")}
                    readOnly
                  />
                </div>
              </div>
